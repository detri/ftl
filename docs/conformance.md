...
| `<sstream>`                                                   | PARTIAL       | String-buffer seek arithmetic is checked before addition, large put positions are restored without narrowing to `int`, and locale exchange inherits the repaired `basic_streambuf::swap`; normal/replacement overflow regressions pass. The common stream exception-state dependency remains open.                                                                                                                                                                                                    |
...
| `<spanstream>`                                                | PARTIAL       | Span-buffer seek arithmetic is checked before addition, large put positions are restored without narrowing to `int`, and buffer locale exchange inherits the repaired base swap; normal/replacement overflow regressions pass. The common stream exception-state dependency remains open.                                                                                                                                                                                                              |
