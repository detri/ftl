...
| `<cerrno>` / `<errno.h>`                                      | OPEN          | Historical platform `errno` macro-value findings remain, including Darwin `EILSEQ`.                                                                                                                                                                                                                            |
| `<csetjmp>` / `<setjmp.h>`                                    | CERTIFIED     | Historically certified; final dependency-invalidation pass pending.                                                                                                                                                                                                                                            |
| `<csignal>` / `<signal.h>`                                    | OPEN          | Historical platform signal-constant findings remain, including Windows `SIGABRT`.                                                                                                                                                                                                                              |
...
| `<format>`                                                    | PARTIAL       | Adaptor formatter support was added, but the standalone `<format>` audit defects have not all been reconciled.                                                                                                                                                                                                 |
...
| `<cwchar>`                                                    | OPEN          | Historical multibyte conversion, wide-I/O, locale-sensitive parsing/collation/time-formatting, and `WEOF` findings remain to be reconciled.                                                                                                                                                                    |
...
| `<iterator>` / range access                                   | PARTIAL       | Substantial implementation and test changes landed, but its historical defect list has not been fully reconciled.                                                                                                                                                                                              |
| `<ranges>`                                                    | REMEDIATED    | Recorded range/access/view findings fixed with focused normal/replacement validation.                                                                                                                                                                                                                          |
| `<generator>`                                                 | OPEN          | Historical normal-mode `elements_of` range `yield_value` definition defect remains to be reconciled against the current tree.                                                                                                                                                                                  |
...
| `<memory>` specialized algorithms                             | OPEN          | Historical uninitialized-memory, destruction, and C++23 ranges raw-memory algorithm findings have not been reconciled.                                                                                                                                                                                         |
| `<memory_resource>`                                           | OPEN          | Historical pool-resource option/replenishment and monotonic-resource growth findings have not been reconciled.                                                                                                                                                                                                 |
| `<scoped_allocator>`                                          | OPEN          | Historical propagation-trait and converting-constructor constraint findings have not been reconciled.                                                                                                                                                                                                          |
| `<cstdlib>` / `<stdlib.h>`                                    | OPEN          | Historical declarations, overload, conversion, allocation, termination, and freestanding/hosted findings remain.                                                                                                                                                                                               |
| `<cfenv>` / `<fenv.h>`                                        | OPEN          | Historical floating-point exception/trap and environment behavior findings remain.                                                                                                                                                                                                                             |
| `<complex>`                                                   | OPEN          | Historical constructor, assignment, operator, overload, stream-state, and numerical-behavior findings remain.                                                                                                                                                                                                  |
...
| `<valarray>`                                                  | OPEN          | Historical construction, lifetime, expression, slice, shift, overload, and complexity findings remain.                                                                                                                                                                                                         |
...
| `<cmath>` core                                                | OPEN          | Historical classification, comparison, overload, promotion, evaluation-type, error, and mathematical behavior findings remain.                                                                                                                                                                                 |
| `<cmath>` mathematical special functions                      | OPEN          | Historical special-function availability, overload, domain, error, accuracy, and extended-arithmetic findings remain.                                                                                                                                                                                          |
| `<chrono>` durations, time points, and clocks                 | OPEN          | Historical arithmetic, conversion, rounding, clock, constraint, comparison, and extended-representation findings remain.                                                                                                                                                                                       |
| `<chrono>` civil calendar and `hh_mm_ss`                      | OPEN          | Historical calendar overflow, conversions, validation, arithmetic, and extended-duration `hh_mm_ss` findings remain.                                                                                                                                                                                           |
| `<chrono>` UTC/TAI/GPS/file clocks and clock conversion       | OPEN          | Historical clock types, epochs, conversions, leap-second handling, and `clock_cast` participation findings remain.                                                                                                                                                                                             |
| `<chrono>` time-zone database and `zoned_time`                | OPEN          | Historical tzdb, zone lookup, local-time resolution, exception, and name-taking `zoned_time` constructor-constraint findings remain.                                                                                                                                                                           |
| `<chrono>` formatting                                         | OPEN          | Historical chrono formatter grammar, localization, alternative representations, extended-duration precision, output, and participation findings remain.                                                                                                                                                        |
...
| `<locale>` localization library                               | OPEN          | Historical locale, facet, category, collation, conversion, numeric, monetary, time, synchronization, and deprecated-conversion findings remain.                                                                                                                                                                |
...
| `<iosfwd>` / `<ios>`                                          | OPEN          | Historical `iword`/`pword` allocation-failure storage and thread-isolation findings remain.                                                                                                                                                                                                                    |
| `<streambuf>`                                                 | OPEN          | Historical `basic_streambuf::swap` locale-state defect remains.                                                                                                                                                                                                                                                |
...
| `<print>`                                                     | PARTIAL       | Complete print/println/vprint surface and terminal routing landed, but formatter participation inherited from unresolved `<format>` findings still prevents closure.                                                                                                                                           |
| `<sstream>`                                                   | OPEN          | Historical large-position narrowing, seek-overflow, locale-swap, and inherited stream exception-state findings remain.                                                                                                                                                                                         |
| `<strstream>`                                                 | OPEN          | Historical underflow visibility, external-buffer put-area, and allocation/deallocation findings remain.                                                                                                                                                                                                        |
| `<spanstream>`                                                | OPEN          | Historical large-position narrowing, seek-overflow, and inherited stream/buffer findings remain.                                                                                                                                                                                                               |
...
| `<cinttypes>` / `<inttypes.h>`                                | PARTIAL       | Direct C++23 inventory historically matched; the inherited `<cstdint>` width/model defect is now remediated, but focused `<cinttypes>` revalidation is still required.                                                                                                                                         |
| `<ctime>` / `<time.h>`                                        | OPEN          | Historical `difftime`, `gmtime`, pre-epoch `timespec_get`, and native `tm` ABI findings remain.                                                                                                                                                                                                                |
...
| `<__c_time_types.hpp>` support unit                           | OPEN          | Historical native `tm` layout/ABI mismatch and `%z`/`%Z` findings remain.                                                                                                                                                                                                                                      |
| `<regex>`                                                     | OPEN          | Historical moved-from validity, non-throwing move, constant-time swap, and related regex-state findings remain to be reconciled.                                                                                                                                                                               |
| `<atomic>` / `<stdatomic.h>`                                  | OPEN          | Historical extended-integer atomic specialization and arithmetic/bitwise-operation findings remain to be reconciled.                                                                                                                                                                                           |
| `<stop_token>`                                                | CERTIFIED     | Historically certified; final dependency-invalidation pass pending.                                                                                                                                                                                                                                            |
| `<thread>` / `jthread`                                        | OPEN          | Historical large-duration `sleep_for` overflow and unresolved chrono extended-representation dependencies remain.                                                                                                                                                                                              |
| `<mutex>` / `<shared_mutex>` / `<condition_variable>`         | OPEN          | Historical missing `native_handle_type` / `native_handle()` interfaces and timed-operation chrono dependencies remain.                                                                                                                                                                                         |
| `<semaphore>`                                                 | OPEN          | Core synchronization semantics historically matched, but timed acquisition remains dependent on unresolved chrono extended-representation behavior.                                                                                                                                                            |
...
| `<future>`                                                    | OPEN          | Historical `packaged_task` callable-participation defect and timed-wait chrono dependencies remain.                                                                                                                                                                                                            |
| `<stdexcept>`                                                 | CERTIFIED     | Historically certified; final dependency-invalidation pass pending.                                                                                                                                                                                                                                            |
| `<system_error>`                                              | OPEN          | Historical Windows system-category message/default-condition interpretation findings remain.                                                                                                                                                                                                                   |
| `<stacktrace>`                                                | OPEN          | Historical stacktrace findings were dropped from the copied progress table and remain to be reconciled against the current tree.                                                                                                                                                                               |
