...
| `<random>`                                                    | PARTIAL       | Seed-sequence overload exclusion now follows implicit convertibility to the engine result type, and `generate_canonical` cannot round to `1`; regressions cover both plus supported extended arithmetic. Historical engine, distribution, serialization, and remaining numerical requirements remain.                                                                                                                                                                                                    |
