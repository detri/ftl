 ...
 */
void ftl_olm___scan_nan(uint32_t *__words, int __num_words, const char *__s);

/*
 * Functions internal to the math package, yet not static.
 */
double ftl_olm___exp__D(double, double);
struct Double ftl_olm___log__D(double);
long double ftl_olm___p1evll(long double, void *, int);
long double ftl_olm___polevll(long double, void *, int);
