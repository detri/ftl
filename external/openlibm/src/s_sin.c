...
ftl_olm_sin(double x)
{
	...
	if(ix <= 0x3fe921fb) {
	    ...
	    return ftl_olm___kernel_sin(x,z,0);
	}
    ...
    /* argument reduction needed */
	    ...
	    switch(n&3) {
		case 0: return  ftl_olm___kernel_sin(y[0],y[1],1);
		case 1: return  ftl_olm___kernel_cos(y[0],y[1]);
		case 2: return -ftl_olm___kernel_sin(y[0],y[1],1);
		default:
			return -ftl_olm___kernel_cos(y[0],y[1]);
	    }
	}
}

#if (LDBL_MANT_DIG == 53)
openlibm_weak_reference(ftl_olm_sin, ftl_olm_sinl);
#endif
