...
static_assert(tested::is_same_v<decltype(&tested::remove), int (*)(const char *)>);
...
static_assert(tested::is_same_v<decltype(&tested::setbuf),
                                void (*)(file *, char *)>);
...
static_assert(tested::is_same_v<decltype(&tested::fscanf),
                                int (*)(file *, const char *, ...)>);
static_assert(tested::is_same_v<decltype(&tested::printf),
                                int (*)(const char *, ...)>);
static_assert(tested::is_same_v<decltype(&tested::scanf),
                                int (*)(const char *, ...)>);
...
static_assert(tested::is_same_v<decltype(&tested::vfscanf),
                                int (*)(file *, const char *, args)>);
static_assert(tested::is_same_v<decltype(&tested::vprintf),
                                int (*)(const char *, args)>);
static_assert(tested::is_same_v<decltype(&tested::vscanf),
                                int (*)(const char *, args)>);
...
static_assert(tested::is_same_v<decltype(&tested::fgets),
                                char *(*)(char *, int, file *)>);
static_assert(tested::is_same_v<decltype(&tested::fputc),
                                int (*)(int, file *)>);
static_assert(tested::is_same_v<decltype(&tested::fputs),
                                int (*)(const char *, file *)>);
...
static_assert(tested::is_same_v<decltype(&tested::puts), int (*)(const char *)>);
static_assert(tested::is_same_v<decltype(&tested::ungetc),
                                int (*)(int, file *)>);
...
static_assert(tested::is_same_v<decltype(&tested::fgetpos),
                                int (*)(file *, position *)>);
static_assert(tested::is_same_v<decltype(&tested::fseek),
                                int (*)(file *, long, int)>);
...
static_assert(tested::is_same_v<decltype(&tested::perror), void (*)(const char *)>);
