...
#if defined(_MSC_VER)
static_assert(tested::is_same_v<tested::intmax_t, long long>);
static_assert(tested::is_same_v<tested::uintmax_t, unsigned long long>);
#else
static_assert(tested::is_same_v<tested::intmax_t, __INTMAX_TYPE__>);
static_assert(tested::is_same_v<tested::uintmax_t, __UINTMAX_TYPE__>);
#endif

static_assert(sizeof(tested::intmax_t) >= sizeof(long long));
static_assert(sizeof(tested::uintmax_t) >= sizeof(unsigned long long));

#if defined(__SIZEOF_INT128__)
static_assert(tested::is_integral_v<__int128>);
static_assert(tested::is_integral_v<unsigned __int128>);
static_assert(tested::is_signed_v<__int128>);
static_assert(tested::is_unsigned_v<unsigned __int128>);
static_assert(
    tested::is_same_v<tested::make_unsigned_t<__int128>, unsigned __int128>);
static_assert(
    tested::is_same_v<tested::make_signed_t<unsigned __int128>, __int128>);

// C++23 permits intmax_t to exclude extended integer types wider
// than long long.
static_assert(sizeof(tested::intmax_t) <= sizeof(__int128));
#endif
...
#if defined(_MSC_VER)
static_assert(INTMAX_MIN == INT64_MIN);
static_assert(INTMAX_MAX == INT64_MAX);
static_assert(UINTMAX_MAX == UINT64_MAX);
#else
static_assert(INTMAX_MIN == (-__INTMAX_MAX__ - 1));
