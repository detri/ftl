...
static_assert(tested::is_arithmetic_v<double> &&
              tested::is_fundamental_v<void> && tested::is_scalar_v<int *> &&
              tested::is_compound_v<int *>);
...
static_assert(
    tested::is_member_object_pointer_v<decltype(&base_type::member)> &&
    tested::is_member_function_pointer_v<decltype(&base_type::function)> &&
...
static_assert(tested::is_pointer_interconvertible_base_of_v<pointer_base,
                                                            pointer_derived>);
...
static_assert(tested::is_same_v<tested::common_reference_t<int &, const int &>,
                                const int &>);
static_assert(
    tested::is_same_v<tested::common_reference_t<int &&, int &>, const int &>);
...
concept has_common_reference =
    requires { typename tested::common_reference_t<T...>; };
...
static_assert(
    tested::is_same_v<tested::make_unsigned_t<scoped_enum>, unsigned>);
static_assert(
    tested::is_same_v<tested::make_signed_t<const scoped_enum>, const int>);
...
static_assert(
    tested::is_same_v<tested::invoke_result_t<decltype(&invocable_type::value),
                                              invocable_type>,
                      int &&>);
...
struct throwing_result {
  constexpr operator int() const noexcept(false) { return 0; }
};
...
static_assert(
    !tested::is_nothrow_invocable_r_v<int, decltype(returns_throwing)>);
...
static_assert(
    tested::is_pointer_interconvertible_with_class(&layout_one::first));
static_assert(
    !tested::is_pointer_interconvertible_with_class(&layout_one::second));
static_assert(tested::is_corresponding_member(&layout_one::first,
                                              &layout_two::first));

#if defined(__SIZEOF_INT128__)
using signed_extended_integer = __int128;
using unsigned_extended_integer = unsigned __int128;

static_assert(tested::is_integral_v<signed_extended_integer>);
static_assert(tested::is_integral_v<unsigned_extended_integer>);
static_assert(tested::is_integral_v<const signed_extended_integer>);
static_assert(tested::is_integral_v<volatile unsigned_extended_integer>);

static_assert(tested::is_arithmetic_v<signed_extended_integer>);
static_assert(tested::is_fundamental_v<signed_extended_integer>);
static_assert(tested::is_scalar_v<signed_extended_integer>);
static_assert(tested::is_signed_v<signed_extended_integer>);
static_assert(tested::is_unsigned_v<unsigned_extended_integer>);

static_assert(
    tested::is_same_v<tested::make_unsigned_t<signed_extended_integer>,
                      unsigned_extended_integer>);
static_assert(
    tested::is_same_v<tested::make_signed_t<unsigned_extended_integer>,
                      signed_extended_integer>);

static_assert(
    tested::is_same_v<tested::make_unsigned_t<const signed_extended_integer>,
                      const unsigned_extended_integer>);
static_assert(
    tested::is_same_v<tested::make_signed_t<volatile unsigned_extended_integer>,
                      volatile signed_extended_integer>);
#endif

static_assert(!tested::is_copy_constructible_v<void>);
static_assert(!tested::is_move_constructible_v<void>);
static_assert(!tested::is_trivially_copy_constructible_v<void>);
static_assert(!tested::is_trivially_move_constructible_v<void>);
static_assert(!tested::is_nothrow_copy_constructible_v<void>);
static_assert(!tested::is_nothrow_move_constructible_v<void>);

static_assert(!tested::is_copy_assignable_v<void>);
static_assert(!tested::is_move_assignable_v<void>);
static_assert(!tested::is_trivially_copy_assignable_v<void>);
static_assert(!tested::is_trivially_move_assignable_v<void>);
static_assert(!tested::is_nothrow_copy_assignable_v<void>);
static_assert(!tested::is_nothrow_move_assignable_v<void>);

static_assert(!tested::is_swappable_v<void>);
static_assert(!tested::is_nothrow_swappable_v<void>);

using swappable_array_reference = int (&)[2];

static_assert(tested::is_swappable_with_v<swappable_array_reference,
                                          swappable_array_reference>);
static_assert(tested::is_nothrow_swappable_with_v<swappable_array_reference,
                                                  swappable_array_reference>);

using immobile_array_reference = immobile (&)[2];

static_assert(!tested::is_swappable_with_v<immobile_array_reference,
                                           immobile_array_reference>);
static_assert(!tested::is_nothrow_swappable_with_v<immobile_array_reference,
                                                   immobile_array_reference>);
