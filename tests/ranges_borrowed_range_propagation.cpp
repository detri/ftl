...
struct non_common_range {
    ...
    constexpr pointer_sentinel end() noexcept {
        return {last};
    }
};
...
constexpr bool operator==(
    const input_iterator& iterator,
    input_sentinel sentinel
) noexcept {
...
using borrowed_base =
    tested::ranges::ref_view<int[4]>;

using non_borrowed_base =
...
using borrowed_pair_base =
    tested::ranges::ref_view<tested::pair<int, int>[2]>;
...
concept correctly_borrowed =
    ...
    tested::ranges::borrowed_range<R> &&
    tested::same_as<
        tested::ranges::borrowed_iterator_t<R>,
...
static_assert(correctly_borrowed<
...
using borrowed_owning =
    tested::ranges::owning_view<borrowed_non_common_base>;
...
using borrowed_take =
    tested::ranges::take_view<borrowed_base>;

using non_borrowed_take =
    tested::ranges::take_view<non_borrowed_base>;

static_assert(correctly_borrowed<borrowed_take>);
static_assert(correctly_non_borrowed<non_borrowed_take>);

using borrowed_drop =
    tested::ranges::drop_view<borrowed_base>;

using non_borrowed_drop =
    tested::ranges::drop_view<non_borrowed_base>;
...
using borrowed_reverse =
    tested::ranges::reverse_view<borrowed_base>;

using non_borrowed_reverse =
    tested::ranges::reverse_view<non_borrowed_base>;

static_assert(correctly_borrowed<borrowed_reverse>);
static_assert(correctly_non_borrowed<non_borrowed_reverse>);

using borrowed_common =
    tested::ranges::common_view<borrowed_non_common_base>;
...
using borrowed_elements =
    tested::ranges::elements_view<borrowed_pair_base, 0>;
...
using borrowed_as_const =
    tested::ranges::as_const_view<borrowed_base>;

using non_borrowed_as_const =
    tested::ranges::as_const_view<non_borrowed_base>;

static_assert(correctly_borrowed<borrowed_as_const>);
static_assert(correctly_non_borrowed<non_borrowed_as_const>);

using borrowed_stride =
    tested::ranges::stride_view<borrowed_base>;

using non_borrowed_stride =
    tested::ranges::stride_view<non_borrowed_base>;

static_assert(correctly_borrowed<borrowed_stride>);
static_assert(correctly_non_borrowed<non_borrowed_stride>);

using borrowed_enumerate =
    tested::ranges::enumerate_view<borrowed_base>;
...
using borrowed_adjacent =
    tested::ranges::adjacent_view<borrowed_base, 2>;
...
using borrowed_slide =
    tested::ranges::slide_view<borrowed_base>;

using non_borrowed_slide =
    tested::ranges::slide_view<non_borrowed_base>;
...
using borrowed_chunk =
    tested::ranges::chunk_view<borrowed_base>;

using non_borrowed_chunk =
    tested::ranges::chunk_view<non_borrowed_base>;

using borrowed_input_chunk =
    tested::ranges::chunk_view<borrowed_input_base>;
...
using join_outer =
    tested::ranges::subrange<borrowed_base*>;

using join_type =
    tested::ranges::join_view<join_outer>;
...
static_assert(correctly_non_borrowed<
    tested::ranges::single_view<int>
>);
