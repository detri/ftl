...
struct unsized_pointer_sentinel
{
    ...
    friend constexpr bool operator==(
        int* current,
        unsized_pointer_sentinel bound
    ) noexcept
    {
...
struct mutable_pointer_view
    : tested::ranges::view_base
{
    int* first = nullptr;
    int* last = nullptr;

    constexpr mutable_pointer_view() =
        default;
...
struct bidirectional_noncommon_view
    : tested::ranges::view_base
{
    int* first = nullptr;
    int* last = nullptr;

    constexpr bidirectional_noncommon_view() =
        default;
    ...
    constexpr bidirectional_sentinel
    end() const noexcept
    {
        return {
            last
...
struct move_only_view
    : tested::ranges::view_base
{
    int* first = nullptr;
    int* last = nullptr;

    constexpr move_only_view() =
        default;
    ...
    move_only_view(
        const move_only_view&
    ) = delete;

    move_only_view& operator=(
        const move_only_view&
    ) = delete;
    ...
    constexpr move_only_view& operator=(
        move_only_view&&
    ) noexcept = default;
...
struct move_only_value
{
    ...
    constexpr explicit move_only_value(
        int value
    ) noexcept
        : value(value)
    {
    ...
    move_only_value(
        const move_only_value&
    ) = delete;

    move_only_value& operator=(
        const move_only_value&
    ) = delete;
    ...
    constexpr move_only_value& operator=(
        move_only_value&&
    ) noexcept = default;
};
...
struct move_only_transform
{
    ...
    move_only_transform(
        const move_only_transform&
    ) = delete;

    move_only_transform& operator=(
        const move_only_transform&
    ) = delete;
    ...
    constexpr move_only_transform& operator=(
        move_only_transform&&
    ) noexcept = default;
...
static_assert(
    has_const_sentinel_type<
        pointer_view<int>
    >
);

static_assert(
    has_range_value_type<
        pointer_view<int>
    >
);

static_assert(
    has_range_reference_type<
        pointer_view<int>
    >
);

static_assert(
    has_range_rvalue_reference_type<
        pointer_view<int>
    >
);

static_assert(
    has_range_difference_type<
        pointer_view<int>
    >
);
...
static_assert(
    has_borrowed_iterator_type<
        pointer_view<int>
    >
);

static_assert(
    has_borrowed_subrange_type<
        pointer_view<int>
    >
);
...
struct mutable_random_access_interface_view
    : tested::ranges::
          view_interface<
              mutable_random_access_interface_view
          >
{
    int* first = nullptr;
    int* last = nullptr;
...
static_assert(
    has_member_empty<
        const random_access_interface_view&
    >
);
...
static_assert(
    !has_member_empty<
        const mutable_random_access_interface_view&
    >
);
...
static_assert(
    can_form_single_view<int>
);

static_assert(
    can_form_single_view<
        move_only_value
    >
);
...
template<
    class Iterator,
    class Sentinel,
    tested::ranges::subrange_kind Kind
>
...
concept can_form_zip_transform_view =
    requires {
        typename tested::ranges::
            zip_transform_view<
                Function,
...
template<
    ...
    tested::size_t Count
>
concept can_form_adjacent_transform_view =
    requires {
        typename tested::ranges::
...
concept can_form_cartesian_product_view =
    requires {
        typename tested::ranges::
...
static_assert(
    can_form_adjacent_transform_view<
        binary_transform,
        integer_view,
        2
    >
...
static_assert(
    can_form_cartesian_product_view<
        input_view
    >
);
